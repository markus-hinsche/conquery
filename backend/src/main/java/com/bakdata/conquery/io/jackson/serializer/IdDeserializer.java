...
public class IdDeserializer<ID extends Id<?>> extends JsonDeserializer<ID> implements ContextualDeserializer {
	...
	public static <ID extends Id<?>> ID deserializeId(String text, Parser<ID> idParser, boolean checkForInjectedPrefix, DeserializationContext ctx)
	...
	public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
		...
		Parser<Id<Identifiable<?>>> parser = Id.<Id<Identifiable<?>>>createParser((Class) idClass);
