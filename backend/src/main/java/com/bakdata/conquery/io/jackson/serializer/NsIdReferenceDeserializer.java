...
@AllArgsConstructor
@NoArgsConstructor
public class NsIdReferenceDeserializer<ID extends NamespacedId & Id<T>, T extends Identifiable<?>> extends JsonDeserializer<T> implements ContextualDeserializer {
	...
	public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
		...
		Class<ID> idClass = Id.findIdClass(cl);
