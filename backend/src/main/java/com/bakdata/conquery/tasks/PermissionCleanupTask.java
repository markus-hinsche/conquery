...
public class PermissionCleanupTask extends Task {
     ...
     * @return The number of deleted permissions.
     */
    public static <E extends IdentifiableImpl<ID> & Owned, ID extends Id<E>> int deletePermissionsOfOwnedInstances(MetaStorage storage, String permissionDomain, Id.Parser<ID> idParser, Function<ID, E> instanceStorageExtractor) {
        int countDeleted = 0;
